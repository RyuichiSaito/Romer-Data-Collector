...
// MFCApplication2.cpp : アプリケーションのクラス動作を定義します。
//
...
//RDS_ON_COPY_DATA(CMFCApplication2App, CDialog);
//RDS_ON_SERVER_AVAILABLE(CMFCApplication2App, RDS_REMOTE_MOUSE_OFF);
//RDS_ON_REMOVE_FROM_SERVER(CMFCApplication2App)
...
// 唯一の CMFCApplication2App オブジェクト

CMFCApplication2App theApp;


// CMFCApplication2App の初期化
